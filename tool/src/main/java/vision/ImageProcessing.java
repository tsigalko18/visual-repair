...
public class ImageProcessing
{
	...
	public List<org.openqa.selenium.Point> compareImages(String referenceImagePath, String referenceImageName, String comparisonImagePath, String comparisonImageName)
	{
		...
		Imgcodecs.imwrite(comparisonImagePath + File.separatorChar + "diff" + (Util.getNumbersFromString(comparisonImageName).size() > 0?Util.getNumbersFromString(comparisonImageName).get(0):"") + ".png", outDiff);
