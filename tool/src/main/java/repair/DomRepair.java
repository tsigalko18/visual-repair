...
// String string =
// correctTestCase.getStatements().get(Integer.parseInt(exception.getInvolvedLine())).getAnnotatedScreenshot().toString();
//
...
//
// path = Settings.pathToTestSuiteUnderTest +
// DirectBreakage.class.getSimpleName() + Settings.javaExtension;
// EnhancedTestCase brokenTestCase = ParseTest.parse(path);
// string =
// brokenTestCase.getStatements().get(Integer.parseInt(exception.getInvolvedLine())).getAnnotatedScreenshot().toString();
//
// dir = currentDirectory + Settings.separator + string.replace(".png",
// "").replace("Annotated", "2after");
...
//
// String locator =
// "/html[1]/body[1]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/form[1]/fieldset[1]/input[1]";
//
...
// }
//
// private static void printResults(List<Node<HtmlElement>> result,
