...
//				Statement oldst = testCorrect.getStatements().get(Integer.parseInt(exception.getInvolvedLine()));
//
//				// get the correct statement in the correct version
//				Statement newst = testBroken.getStatements().get(Integer.parseInt(exception.getInvolvedLine()));
//				
