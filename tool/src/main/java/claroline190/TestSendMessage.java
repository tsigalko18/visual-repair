...
public class TestSendMessage {
	...
	public void testSendMessage() throws Exception {
		...
		// driver.findElement(By.linkText("Send a message to all
		// users")).click();
		...
		// driver.findElement(By.cssSelector("#mce_18_aria >
		// span.mceText")).click();
		...
		// assertTrue(driver.findElement(By.cssSelector("div.claroDialogBox.boxInfo")).getText().matches("^[\\s\\S]*Message
		// sent[\\s\\S]*$"));
