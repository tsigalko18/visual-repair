...
//    	String path = joinPoint.getTarget().toString().split("@")[0]; 	// clarolineDirectBreakage.DirectBreakage
//    	path = path.split("\\.")[0]; 									// clarolineDirectBreakage
//    	path = "src" + Settings.separator + path; 						// src/clarolineDirectBreakage
//    	
//    	System.out.println("\n[LOG]\tExiting Test " + joinPoint.getStaticPart().getSignature().getName());
//        try {
//			ParseTest.getMethodLineNumbers(path, joinPoint.getStaticPart().getSourceLocation().getFileName());
