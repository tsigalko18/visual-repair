package clarolineMultipleBreakage;
...
public class MultipleBreakage {
	...
	public void testHomePage() throws Exception {
        ...
        assertTrue(driver.findElement(By.id("userName")).getText().contains("John Doe")); // test breaks HERE, fault is here
	}
	...
	/**
	 * This test contains two locator breakages: XPath at line 32 and id at line 33
	 */
}
