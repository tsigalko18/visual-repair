...
\head{Scenario 1 (Non-Selection Same State (Direct))} 
...
This scenario is depicted in~\autoref{claroline-together}: \textcircled{\raisebox{-0.9pt}{1}}~shows the login form of Claroline web application version 1.10.0, together with the corresponding HTML code~\textcircled{\raisebox{-0.9pt}{2}}. \textcircled{\raisebox{-0.9pt}{3}}~shows the login form on the next major version of Claroline (1.11.0), and how the corresponding HTML code has evolved~\textcircled{\raisebox{-0.9pt}{4}}. 
