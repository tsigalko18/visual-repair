...
\autoref{claroline-together}~\textcircled{\raisebox{-0.9pt}{5}} shows an automated test case implementing such scenario, developed using the Selenium WebDriver~\cite{selenium}.
