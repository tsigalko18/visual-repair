...
public class ElementMovedNewStateWithLocalCrawling {
	...
	static List<EnhancedTestCase> searchElementNewState(EnhancedException e, EnhancedTestCase b, EnhancedTestCase c, boolean check)
		...
		System.out.println("[LOG]\tApplying repair strategy <searchElementNewStateWithLocalCrawling>");
...
//		}
		...
		Crawler crawler = new Crawler("file:///" + htmlFile);
		crawler.runLocalCrawling();
