...
public class ScreenshotSaver {
	...
	public void loggingAdvice(JoinPoint jp) {
		...
		testFolderName = Settings.outputFolder + testSuiteName + Settings.separator + jp.getStaticPart().getSourceLocation().getFileName().replace(Settings.JAVA_EXTENSION, "");
	...
	public void beforeEvent(JoinPoint joinPoint)  {
		...
		String screenshotBeforeEvent 			= testFolderName + Settings.separator + line + "-1before-" + statementName + Settings.PNG_EXTENSION;
		String annotatedscreenshotBeforeEvent 	= testFolderName + Settings.separator + line + "-Annotated-" + statementName + Settings.PNG_EXTENSION;
		String visualLocator 					= testFolderName + Settings.separator + line + "-visualLocator-" + statementName + Settings.PNG_EXTENSION;
...
//		UtilsScreenshots.saveVisualCrop(d, screenshotBeforeEvent, we, visualLocator);
	...
	public void afterEvent(JoinPoint joinPoint) {	
		...
		// save the screenshot before the execution of the event
		String screenshotBeforeEvent 	= testFolderName + Settings.separator + line + "-2after-" + statementName + Settings.PNG_EXTENSION;
