...
\centering
\includegraphics[trim=0.1cm 5cm 0.1cm 0.1cm, clip=true, scale=0.155]{images/ab1.pdf}
...
\centering
\fbox{
{\includegraphics[trim=0.1cm 13cm 19cm 0.1cm, clip=true, scale=0.27]{images/sikuli-s.pdf}}
}
