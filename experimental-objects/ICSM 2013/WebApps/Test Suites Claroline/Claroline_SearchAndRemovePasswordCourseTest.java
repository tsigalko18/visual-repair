...
public class ClarolineSearchAndRemovePasswordCourseTest {
  ...
  public void testClarolineSearchAndRemovePasswordCourse() throws Exception {
      ...
      assertEquals("Course002", driver.findElement(By.xpath(".//*[@id='claroBody']/table[2]/tbody/tr/td[2]")).getText());
      driver.findElement(By.cssSelector("#Course002__002 > img")).click();
      assertTrue(closeAlertAndGetItsText().matches("^Are you sure to delete \" Course002\" [\\s\\S] $"));
