...
public class ClarolineAddDeniedCourseTest {
  ...
  public void testClarolineAddDeniedCourse() throws Exception {
      ...
      assertEquals("You have just created the course website : 003", driver.findElement(By.xpath(".//*[@id='claroBody']/div[1]/div")).getText());
