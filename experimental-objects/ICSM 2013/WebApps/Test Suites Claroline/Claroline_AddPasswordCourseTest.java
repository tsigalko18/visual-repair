...
public class ClarolineAddPasswordCourseTest {
  ...
  public void testClarolineAddPasswordCourse() throws Exception {
      ...
      // ERROR: Caught exception [ERROR: Unsupported command [addSelection | id=mslist2 | label=Humanities]]
      ...
      driver.findElement(By.id("registrationKey")).clear();
      ...
      assertEquals("You have just created the course website : 002", driver.findElement(By.xpath(".//*[@id='claroBody']/div[1]/div")).getText());
