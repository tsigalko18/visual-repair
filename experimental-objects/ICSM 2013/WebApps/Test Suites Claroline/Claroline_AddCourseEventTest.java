...
public class ClarolineAddCourseEventTest {
  ...
  public void testClarolineAddCourseEvent() throws Exception {
      ...
      new Select(driver.findElement(By.id("fyear"))).selectByVisibleText("2013");
      driver.findElement(By.id("location")).clear();
      driver.findElement(By.id("location")).sendKeys("Genoa");
      driver.findElement(By.name("submitEvent")).click();
      assertEquals("Event added to the agenda.", driver.findElement(By.xpath(".//*[@id='claroBody']/div[1]/div")).getText());
