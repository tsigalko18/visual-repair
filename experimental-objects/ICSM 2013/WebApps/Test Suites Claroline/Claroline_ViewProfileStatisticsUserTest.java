...
public class ClarolineViewProfileStatisticsUserTest {
  ...
  public void testClarolineViewProfileStatisticsUser() throws Exception {
      ...
      assertEquals("Exercise 001", driver.findElement(By.xpath(".//*[@id='leftContent']/div[3]/div[2]/table/tbody/tr[1]/td[1]/a")).getText());
