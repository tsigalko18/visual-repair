...
public class ClarolineEnrolPasswordCourseGoodPasswordUserTest {
  ...
  public void testClarolineEnrolPasswordCourseGoodPasswordUser() throws Exception {
      ...
      driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
      assertEquals("You've been enrolled on the course", driver.findElement(By.xpath(".//*[@id='claroBody']/div[1]/div")).getText());
