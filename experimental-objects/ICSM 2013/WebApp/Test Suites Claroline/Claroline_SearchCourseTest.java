...
public class ClarolineSearchCourseTest {
  ...
  public void testClarolineSearchCourse() throws Exception {
      ...
      assertEquals("Course001", driver.findElement(By.xpath(".//*[@id='claroBody']/table[2]/tbody/tr/td[2]")).getText());
      assertEquals("001", driver.findElement(By.xpath(".//*[@id='L0']")).getText());
